...
export function PageHome({ ...properties }: Readonly<Record<string, unknown>>) {
  ...
  const ctaStyle = useMemo(
    () => (isUsable ? {} : ({ filter: "grayscale(1)", opacity: 0.5, pointerEvents: "none" } satisfies CSSProperties)),
    [isUsable],
  );
        ...
        <div className="grid gap-8 md:grid-cols-3 md:gap-6" style={ctaStyle}>
          ...
          <div className={triggerColumnClasses}>
            ...
            <svg className="h-8" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                d="M108 48H68c12-13-12-27 0-40h-8c-12 13 12 27 0 40H20c-9 0-16 7-16 16v40c0 9 7 16 16 16h88c9 0 16-7 16-16V64c0-9-7-16-16-16zm8 56c0 4-4 8-8 8H20c-4 0-8-4-8-8V64c0-4 4-8 8-8h88c4 0 8 4 8 8v40z"
                fill="currentColor"
              />
            </svg>
          </div>
          <div className={triggerColumnClasses}>
            ...
            <svg className="h-8" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                d="M108 68a4 4 0 10-8 0 36 36 0 01-72 0 4 4 0 10-8 0c0 23 18 42 40 44v8H40a4 4 0 100 8h48a4 4 0 100-8H68v-8c22-2 40-21 40-44z"
                fill="currentColor"
              />
              <path
                d="M64 8c11 0 20 9 20 20v40a20 20 0 01-40 0V28c0-11 9-20 20-20m0-8C49 0 36 13 36 28v40a28 28 0 0056 0V28C92 13 79 0 64 0z"
                fill="currentColor"
              />
            </svg>
          </div>
