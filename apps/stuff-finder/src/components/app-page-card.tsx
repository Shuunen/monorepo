  ...
  return (
    <ThemeProvider theme={theme}>
      <div class="flex max-h-full w-full grow flex-col items-center md:grow-0 print:hidden" data-component="page-card" data-page={pageCode}>
        ...
        <div class="relative z-10 block w-full grow overflow-auto text-purple-700 bg-linear-to-b from-white/80 to-white p-4 sm:p-6 md:w-auto md:min-w-[30rem] md:gap-6 md:rounded-md md:shadow-md">
