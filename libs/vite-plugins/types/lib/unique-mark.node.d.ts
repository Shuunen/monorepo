 ...
 */
export function generateMark({ commit, date, version }: { commit?: string | undefined; date?: string | undefined; version?: string | undefined }): string
/**
 ...
 */
export function injectMarkInAsset({ asset, fileName, mark, placeholder }: { asset: Record<string, string>; fileName: string; mark: string; placeholder: string }): void
/**
 ...
 */
export function uniqueMark(options?: { placeholder?: string | undefined }): import('vite').Plugin
