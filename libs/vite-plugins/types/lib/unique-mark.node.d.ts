 ...
 */
export declare function addColorCode(from: number, to: number, string: string): string;
/**
 * Render a yellow string for the terminal
 * @param {string} string the string to render
 * @returns the string with the yellow color
 */
export declare function yellow(string: string): string;
/**
 ...
 */
export declare function injectMark(content: string, placeholder: string, mark: string): string;
/**
 ...
 */
export declare function generateMark({ commit, date, version }: {
    commit?: string;
    date?: Date;
    version?: string;
}): string;
 ...
 */
export declare function injectMarkInAsset({ asset, fileName, mark, placeholder }: {
 ...
 */
export declare function injectMarkInAssets(assets: Record<string, Record<string, string>>, placeholder: string, version: string): void;
/**
 ...
 */
export declare function getProjectVersion(projectRoot: string): string;
/**
 ...
 */
export declare function uniqueMark(options?: {
    placeholder?: string;
}): import('vite').Plugin;
