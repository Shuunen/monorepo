...
export const Exhaustive: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('boolean fields', async () => {
      const booleanEditable = canvas.getByTestId('switch-boolean')
      ...
      const booleanDisabled = canvas.getByTestId('switch-boolean-disabled')
      expect(booleanDisabled).toBeDisabled()
      expect(booleanDisabled).not.toBeChecked()
      const booleanLiteralChecked = canvas.getByTestId('switch-boolean-literal-checked')
      expect(booleanLiteralChecked).toBeDisabled()
      expect(booleanLiteralChecked).toBeChecked()
      const booleanLiteralUnchecked = canvas.getByTestId('switch-boolean-literal-unchecked')
      expect(booleanLiteralUnchecked).toBeDisabled()
      expect(booleanLiteralUnchecked).not.toBeChecked()
      const booleanOptional = canvas.getByTestId('switch-boolean-optional')
    ...
    await step('email fields', async () => {
      ...
      const emailReadonly = canvas.getByTestId('input-text-email-readonly')
      expect(emailReadonly).toHaveValue('')
    })
    await step('enum fields', async () => {
      const enumEditable = canvas.getByTestId('select-trigger-enum')
      ...
      const enumDisabled = canvas.getByTestId('select-trigger-enum-disabled')
      expect(enumDisabled).toBeDisabled()
      const enumOptional = canvas.getByTestId('select-trigger-enum-optional')
      ...
      const enumReadonly = canvas.getByTestId('select-trigger-enum-readonly')
      expect(enumReadonly).toHaveValue('')
    })
    await step('number fields', async () => {
      const numberEditable = canvas.getByTestId('input-number-number')
      await userEvent.type(numberEditable, '25')
      expect(numberEditable).toHaveValue(25)
      const numberDisabled = canvas.getByTestId('input-number-number-disabled')
      expect(numberDisabled).toBeDisabled()
      expect(numberDisabled).toHaveValue(null)
      const numberOptional = canvas.getByTestId('input-number-number-optional')
      expect(numberDisabled).toHaveValue(null)
      await userEvent.type(numberOptional, '30')
      expect(numberOptional).toHaveValue(30)
      const numberReadonly = canvas.getByTestId('input-number-number-readonly')
      expect(numberReadonly).toHaveValue(null)
    })
    await step('string fields', async () => {
      const stringEditable = canvas.getByTestId('input-text-string')
      await userEvent.type(stringEditable, 'Some text')
      expect(stringEditable).toHaveValue('Some text')
      const stringDisabled = canvas.getByTestId('input-text-string-disabled')
      expect(stringDisabled).toBeDisabled()
      expect(stringDisabled).toHaveValue('')
      const stringOptional = canvas.getByTestId('input-text-string-optional')
      ...
      const stringReadonly = canvas.getByTestId('input-text-string-readonly')
    ...
    await step('password fields', async () => {
      const passwordEditable = canvas.getByTestId('input-password-password')
      ...
      const passwordDisabled = canvas.getByTestId('input-password-password-disabled')
      ...
      const passwordOptional = canvas.getByTestId('input-password-password-optional')
      ...
      const passwordReadonly = canvas.getByTestId('input-password-password-readonly')
