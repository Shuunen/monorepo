 ...
 */ export function isFirefox() {
    /* c8 ignore next 3 */ if (globalThis.navigator === undefined) return false;
 ...
 */ export function addColorCode(from, to, string) {
    /* c8 ignore next */ return isFirefox() ? string : `\u001B[${from}m${string}\u001B[${to}m`;
}
/**
 ...
 */ export function overline(string) {
 ...
 */ export function bgBlack(string) {
 ...
 */ export function bgGreen(string) {
 ...
 */ export function bgYellow(string) {
 ...
 */ export function bgMagenta(string) {
 ...
 */ export function bgWhite(string) {
