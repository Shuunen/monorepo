 ...
 */ export function getPath(url = '', addLang = '') {
    /* c8 ignore next 2 */ let path = url === '' && isBrowserEnvironment() ? document.location.pathname : url;
    if (path === 'blank') path = '';
 ...
 */ export function getPage(url = '') {
    ...
    var _path_split_;
    /* c8 ignore next */ return (_path_split_ = path.split('.')[0]) != null ? _path_split_ : '';
}

//# sourceMappingURL=browser-routing.js.map