 ...
 */ function replacer(key, value) {
    ...
    if (value instanceof RegExp) return {
        __strRegexFlags__: value.flags,
        __strRegexSource__: value.source
    };
    if (typeof value === 'function') return {
        __strFunction__: value.toString()
    };
    ...
    if (this[key] instanceof Date) return {
        __strDate__: this[key].toISOString()
    };
    return value;
}
/**
 ...
 */ function reviver(_key, value) {
    ...
    if ('__strFunction__' in value) return new Function(`return ${value.__strFunction__}`)();
    /* @ts-expect-error non-standard properties */ if ('__strDate__' in value) return new Date(value.__strDate__);
 ...
 */ export function objectSerialize(object, willSortKeys = false) {
 ...
 */ export function objectDeserialize(string) {
