 ...
 */ function toastShow(element, delay = 100) {
    ...
    setTimeout(()=>{
        /* c8 ignore next 2 */ element.style.opacity = '1';
...
function toastAdd(type, message = '', delay = 0, padding = 14) {
    ...
    const last = (_document_querySelector = document.querySelector('.shu-toast:nth-last-child(1 of .shu-toast)')) == null ? void 0 : _document_querySelector.getBoundingClientRect().top;
 ...
 */ export function toastError(message, delay = 4000) {
 ...
 */ export function toastInfo(message, delay = 2000) {
 ...
 */ export function toastSuccess(message, delay = 2000) {
    toastAdd('success', message, delay);
}

//# sourceMappingURL=browser-toast.js.map