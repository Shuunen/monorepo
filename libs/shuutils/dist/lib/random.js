 ...
 */ export function randomEmail(first, last) {
    var _first_;
    const providers = pickOne([
        'gmail.com',
        'yahoo.de',
        'hotmail.fr',
        'outlook.com',
    ...
    /* c8 ignore next */ const email = `${isShort ? (_first_ = first[0]) == null ? void 0 : _first_.toLocaleLowerCase() : first.toLocaleLowerCase()}.${last.toLocaleLowerCase()}@${providers}`;
    return email;
}
/**
 ...
 */ export function randomPerson() {
    ...
    return {
        ...
        firstName: first,
        // oxlint-disable-next-line no-magic-numbers
        income: randomNumber(1000, 10000),
        lastName: last
    };
}
